    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item mt-3">
            <a href="{{ route('dashboard') }}" class="nav-link active" style="background-color:#E9F5FE; color: #5B91EF; font-weight: bold; border-radius: 0;">
                <i class="nav-icon fas fa-home" style="color: #5B91EF;"></i>
