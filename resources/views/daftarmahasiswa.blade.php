                        ...
                        <div id="modalFormContainer">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="form-label text-label">
                                                Nama Lengkap
                                                <span class="italic-parentheses">
                                                    (<span style="font-style: italic; font-weight: bold;">Versi Bahasa
                                                        Indonesia</span>)
                                                </span> *
                                            </label>
                                    ...
                                    <div class="col-md-5">
                                        {{-- <div class="form-group">
                                            <label class="form-label text-label">
                                                Full Name
                                                <span class="italic-parentheses">
                                                    (<span style="font-style: italic; font-weight: bold;">English
                                                        Version</span>)
                                                </span> *
                                            </label>
                            ...
                            <form id="modalForm4" method="POST" action="#" style="display: none;">
                                ...
                                <div class="row mb-2 mx-2">
                                    ...
                                    <div class="col-6 font-weight-bold">Attitude<span
                                            style="font-weight: 200; font-style:italic;"> (English Version) </span>*
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2 mx-2">
                                    <div class="col-6 font-weight-bold">Nomor Ijazah Nasional <span
                                            style="font-weight: 200; font-style:italic;"> (Versi Bahasa Indonesia)
                                        </span>*
                                    </div>
                                    {{-- <div class="col-6 font-weight-bold">Enter Diploma Number<span
                                            style="font-weight: 200; font-style:italic;"> (English Version) </span>*
                                    </div> --}}
                                </div>
                                <div id="modal-statement-container6">
                                    <div class="row mb-2 mx-2 align-items-center">
                                        <div>
                                            <input type="checkbox" class="form-check-input mt-1">
                                        </div>
                                        <div class="col-md-12 mb-2">
                                            <textarea name="nomor_ijazah[]" rows="2" class="form-control auto-resize"
                                                placeholder="Masukkan nomor ijazah nasional"></textarea>
                                        </div>
                                        {{-- <div class="col-md-6 mb-2">
                                            <textarea name="diploma_numbers[]" rows="2" class="form-control auto-resize"
                                                placeholder="Enter diploma number"></textarea>
                                        </div> --}}
                                    </div>
                                </div>
                                <div class="mb-3 mx-3">
